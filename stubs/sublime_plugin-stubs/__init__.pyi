...
# Source: references/python38/sublime_plugin.py (Sublime Text build 4200).

import sublime
from typing import Dict, List, Optional, Tuple, Union
from typing_extensions import override
from sublime_types import Event as Event, Value as Value
...
class CommandInputHandler:
    ...
    def preview(self, text: str) -> str | sublime.Html:
        ...
        """
        ...
    def validate(self, text: str, event: Optional[Event] = ...) -> bool:
        """
    ...
    def confirm(self, text: str, event: Optional[Event] = ...) -> None:
        ...
        """
        ...
    def next_input(self, args: Dict[str, Value]) -> Optional[CommandInputHandler]:
        """
...
class Command:
    ...
    def want_event(self) -> bool:
        ...
        """
        ...
    def input(self, args: Dict[str, Value]) -> Optional[CommandInputHandler]:
        """
...
class EventListener:
    ...
    def on_hover(self, view: sublime.View, point: sublime.Point, hover_zone: sublime.HoverZone) -> None:
        ...
        """
        ...
    def on_query_context(self, view: sublime.View, key: str, operator: sublime.QueryOperator, operand: str, match_all: bool) -> Optional[bool]:
        """
        Called when determining to trigger a key binding with the given context
        key. If the plugin knows how to respond to the context, it should
        return either True of False. If the context is unknown, it should
        ...
        """
        ...
    def on_query_completions(self, view: sublime.View, prefix: str, locations: list[sublime.Point]) -> Union[None, List[sublime.CompletionValue], Tuple[List[sublime.CompletionValue], sublime.AutoCompleteFlags], sublime.CompletionList]:
        """
        Called whenever completions are to be presented to the user.
        ...
        """
        ...
    def on_text_command(self, view: sublime.View, command_name: str, args: sublime.CommandArgs) -> Optional[Tuple[str, sublime.CommandArgs]]:
        """
        Called when a text command is issued. The listener may return a
        (command, arguments) tuple to rewrite the command, or ``None`` to run
        the command unmodified.
        """
        ...
    def on_window_command(self, window: sublime.Window, command_name: str, args: sublime.CommandArgs) -> Optional[Tuple[str, sublime.CommandArgs]]:
        """
        Called when a window command is issued. The listener may return a
        (command, arguments) tuple to rewrite the command, or ``None`` to run
        the command unmodified.
...
class ViewEventListener:
    ...
    def on_hover(self, point: sublime.Point, hover_zone: sublime.HoverZone) -> None:
        ...
        """
        ...
    def on_query_context(self, key: str, operator: sublime.QueryOperator, operand: str, match_all: bool) -> Optional[bool]:
        """
        Called when determining to trigger a key binding with the given context
        key. If the plugin knows how to respond to the context, it should
        return either True of False. If the context is unknown, it should
        ...
        """
        ...
    def on_query_completions(self, prefix: str, locations: list[sublime.Point]) -> Union[None, List[sublime.CompletionValue], Tuple[List[sublime.CompletionValue], sublime.AutoCompleteFlags], sublime.CompletionList]:
        """
        Called whenever completions are to be presented to the user.
        ...
        """
        ...
    def on_text_command(self, command_name: str, args: sublime.CommandArgs) -> Optional[Tuple[str, sublime.CommandArgs]]:
        """
        Called when a text command is issued. The listener may return a
        `` (command, arguments)`` tuple to rewrite the command, or ``None`` to
        run the command unmodified.
