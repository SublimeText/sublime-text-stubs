...
# Source: references/python38/sublime.py (Sublime Text build 4200).
...
def open_dialog(callback: Callable[[str | list[str] | None], None], file_types: list[tuple[str, list[str]]] = ..., directory: Optional[str] = ..., multi_select: bool = ..., allow_folders: bool = ...) -> None:
    """
...
def save_dialog(callback: Callable[[str | None], None], file_types: list[tuple[str, list[str]]] = ..., directory: Optional[str] = ..., name: Optional[str] = ..., extension: Optional[str] = ...) -> None:
    """
...
def select_folder_dialog(callback: Callable[[str | list[str] | None], None], directory: Optional[str] = ..., multi_select: bool = ...) -> None:
    """
...
def choose_font_dialog(callback: Callable[[Value], None], default: Optional[dict[str, Value]] = ...) -> None:
    """
...
def run_command(cmd: str, args: Optional[CommandArgs] = ...) -> None:
    """ Run the named `ApplicationCommand`. """
    ...

def format_command(cmd: str, args: Optional[CommandArgs] = ...) -> str:
    """
...
def html_format_command(cmd: str, args: Optional[CommandArgs] = ...) -> str:
    """
...
def command_url(cmd: str, args: Optional[CommandArgs] = ...) -> str:
    """
...
def encode_value(value: Value, pretty: bool = ..., update_text: Optional[str] = ...) -> str:
    """
...
class Window:
    ...
    def new_html_sheet(self, name: str, contents: str, flags: NewFileFlags = ..., group: int = ...) -> Sheet:
        ...
        """
        ...
    def run_command(self, cmd: str, args: Optional[CommandArgs] = ...) -> None:
        """
    ...
    def show_input_panel(self, caption: str, initial_text: str, on_done: Optional[Callable[[str], None]], on_change: Optional[Callable[[str], None]], on_cancel: Optional[Callable[[], None]]) -> View:
        ...
        """
        ...
    def show_quick_panel(self, items: list[str] | list[list[str]] | list[QuickPanelItem], on_select: Callable[[int], None], flags: QuickPanelFlags = ..., selected_index: int = ..., on_highlight: Optional[Callable[[int], None]] = ..., placeholder: Optional[str] = ...) -> None:
        """
...
class View:
    ...
    def size(self) -> int:
        ...
        ...
    def begin_edit(self, edit_token: int, cmd: str, args: Optional[CommandArgs] = ...) -> Edit: ...
    ...
    def find(self, pattern: str, start_pt: Point, flags: FindFlags = ...) -> Region:
        ...
        """
        ...
    def find_all(self, pattern: str, flags: FindFlags = ..., fmt: Optional[str] = ..., extractions: Optional[list[str]] = ..., within: Optional[Region | list[Region]] = ...) -> list[Region]:
        """
        :param pattern: The regex or literal pattern to search by.
        :param flags: Controls various behaviors of find. See `FindFlags`.
    ...
    def text_point_utf16(self, row: int, col: int, *, clamp_column: bool = ...) -> Point:
        ...
        """
        ...
    def utf8_code_units(self, tp: Optional[Point] = ...) -> int:
        """
        ...
        """
        ...
    def utf16_code_units(self, tp: Optional[Point] = ...) -> int:
        """
    ...
    def show(self, location: Region | Selection | Point, show_surrounds: bool = ..., keep_to_left: bool = ..., animate: bool = ...) -> None:
        ...
        """
        ...
    def show_at_center(self, location: Region | Point, animate: bool = ...) -> None:
        """
    ...
    def unfold(self, x: Region | list[Region]) -> list[Region]:
        ...
        """
        ...
    def add_regions(self, key: str, regions: list[Region], scope: str = ..., icon: str = ..., flags: RegionFlags = ..., annotations: list[str] = ..., annotation_color: str = ..., on_navigate: Optional[Callable[[str], None]] = ..., on_close: Optional[Callable[[], None]] = ...) -> None:
        """
    ...
    def show_popup_menu(self, items: list[str], on_done: Callable[[int], None], flags: int = ...) -> None:
        ...
        """
        ...
    def show_popup(self, content: str, flags: PopupFlags = ..., location: Point = ..., max_width: DIP = ..., max_height: DIP = ..., on_navigate: Optional[Callable[[str], None]] = ..., on_hide: Optional[Callable[[], None]] = ...) -> None:
        """
    ...
    def preserve_auto_complete_on_focus_lost(self) -> None:
        ...
        """
        ...
    def export_to_html(self, regions: Optional[Region | list[Region]] = ..., minihtml: bool = ..., enclosing_tags: bool = ..., font_size: bool = ..., font_family: bool = ...) -> str:
        """
...
class Settings:
    ...
    def setdefault(self, key: str, value: Value) -> Value:
        ...
        """
        ...
    def update(self, other: Union[Settings, Dict[str, Value], Iterable[Tuple[str, Value]]] = ..., /, **kwargs: Value) -> None:
        """
...
class Phantom:
    ...
    """
    id: int | None
    def __init__(self, region: Region, content: str, layout: PhantomLayout, on_navigate: Optional[Callable[[str], None]] = ...) -> None: ...
    @override
    def __eq__(self, rhs: object) -> bool: ...
    @override
    def __repr__(self) -> str: ...
...
class CompletionList:
    ...
    def __init__(self, completions: Optional[list[CompletionValue]] = ..., flags: AutoCompleteFlags = ...) -> None:
        """
        :param completions:
...
class CompletionItem:
    ...
    def snippet_completion(cls, trigger: str, snippet: str, annotation: str = ..., kind: Kind = ..., details: str = ...) -> 'CompletionItem':
        ...
        ...
    @classmethod
    def command_completion(cls, trigger: str, command: str, args: Optional[CommandArgs] = ..., annotation: str = ..., kind: Kind = ..., details: str = ...) -> 'CompletionItem':
        """
